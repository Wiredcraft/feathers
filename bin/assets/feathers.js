/**
 * feathers - v0.0.1 - 2013-09-03
 * https://github.com/Wiredcraft/feathers
 *
 * Copyright (c) 2013 Devops
 * Licensed MIT
 */
/**
...
})(window, window.angular);;angular.module('Feathers', [
  'templates-app',
  'templates-common',
  'Feathers.auth',
  'Feathers.navbar',
...
});;angular.module('Devops.navbar', []).controller('NavbarCtrl', [
  '$rootScope',
  '$scope',
  '$location',
...
]);;angular.module('templates-app', ['navbar/navbar.tpl.html']);
...
angular.module("navbar/navbar.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("navbar/navbar.tpl.html",
    ...
    "    <a\n" +
    "      class='{{el.class}}'\n" +
    "      ng-repeat='el in menu'\n" +
    "      ng-class='{active : el.name == activeElement}'\n" +
    "      href='{{el.url}}'\n" +
    "      >{{el.title}}</a>\n" +
    "  </nav>\n" +
    "\n" +
    "  <nav class='footer'>\n" +
    "    <a href='#/profile' class='space' ng-class='{active : \"profile\" == activeElement}'>\n" +
    "      {{user.name}}\n" +
    "    </a>\n" +
    "    <a href='http://wiredcraft.com' id='logo' target='_blank'>\n" +
    "      <span>wiredcraft</span>\n" +
    "    </a>\n" +
    "  </nav>\n" +
    "</div>\n" +
    "");
